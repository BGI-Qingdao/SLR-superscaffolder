...
my $gnuplot = "$Bin/../../tools/gnuplot-5.2.2/bin/gnuplot";
my $convert = "$Bin/../../tools/ImageMagick-7.0.7-27/bin/convert";
...
sub plot_signal {
	...
	$plot .= " '' u 1:3 w l lw 3 t 'T',";
	$plot .= " '' u 1:4 w l lw 3 t 'C',";
	$plot .= " '' u 1:5 w l lw 3 t 'G'\n";
	$plot .= "reset;\n";
	system "gnuplot <<END\n$plot\nEND\n";
	system "convert $::out.ps $::out.png";
	system "rm $::out.ps $::out.tmp";
...
sub plot_curve {
        ...
        $plot .= "plot '$tmp' u 1:2 w l lc 8 lw 3;\n";
        $plot .= "reset;\n";
        system "gnuplot <<END\n$plot\nEND\n";
        system "convert $::out.ps $::out.png";
        system "rm $::out.ps $::out.tmp";
