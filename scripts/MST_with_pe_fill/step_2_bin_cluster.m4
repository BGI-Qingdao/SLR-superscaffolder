...
BIN/ChopBin --prefix xxx --bin_size MST_BIN_SIZE  --flatten --work_mode 1 --max_bin_size 30000 2>>log_chopbin
check_output xxx.barcodeOnBin

check_input xxx.barcodeOnBin
try_backup_list xxx.cluster
BIN/BinCluster --prefix xxx --thread THREADS --threshold MST_BIN_THRESHOLD --work_mode 1 2>>log_bincluster
