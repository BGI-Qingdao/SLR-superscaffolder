...
BIN/ChopBin --prefix xxx --bin_size HT_BIN_SIZE  --delete_tail TAIL --ht_only  2>>log_chopbin_ht
check_output xxx.barcodeOnBin

check_input xxx.barcodeOnBin
try_backup_list xxx.cluster xxx.bin_cluster
BIN/BinCluster --prefix xxx --thread THREADS --threshold HT_BIN_THRESHOLD --pbc --bin_same_contig  2>>log_bincluster_ht
